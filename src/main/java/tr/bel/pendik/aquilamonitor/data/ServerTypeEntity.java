...
public class ServerTypeEntity {
    ...
    @Id
    @SequenceGenerator(name = "SEQ_GEN", sequenceName = "SEQ_SERVER_TYPE", allocationSize = 1)
    ...
    public boolean equals(Object o) {
        ...
        ServerTypeEntity that = (ServerTypeEntity) o;
...
/*
    @OneToMany(mappedBy = "serverTypeByServerTypeId")
