...
(function (t, r) {
    ...
    if (!Function.prototype.bind) {
        Function.prototype.bind = function H(t) {
            var r = this;
            if (!l(r)) {
    ...
    if (!Array.isArray) {
        Array.isArray = function L(t) {
            return f(t) === "[object Array]"
        }
    }
    var d = Object("a");
    var b = d[0] !== "a" || !(0 in d);
    ...
    if (!Array.prototype.forEach || !m(Array.prototype.forEach)) {
        Array.prototype.forEach = function q(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = arguments[1], i = -1, o = e.length >>> 0;
            if (!l(t)) {
                throw new TypeError
            }
            while (++i < o) {
    ...
    if (!Array.prototype.map || !m(Array.prototype.map)) {
        Array.prototype.map = function z(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0, i = Array(n), o = arguments[1];
            if (!l(t)) {
    ...
    if (!Array.prototype.filter || !m(Array.prototype.filter)) {
        Array.prototype.filter = function K(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0, i = [], o, a = arguments[1];
            if (!l(t)) {
                throw new TypeError(t + " is not a function")
            }
            for (var u = 0; u < n; u++) {
    ...
    if (!Array.prototype.every || !m(Array.prototype.every)) {
        Array.prototype.every = function Q(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0, i = arguments[1];
            if (!l(t)) {
                throw new TypeError(t + " is not a function")
            }
            for (var o = 0; o < n; o++) {
    ...
    if (!Array.prototype.some || !m(Array.prototype.some)) {
        Array.prototype.some = function V(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0, i = arguments[1];
            if (!l(t)) {
                throw new TypeError(t + " is not a function")
            }
    ...
    if (Array.prototype.reduce) {
        w = typeof Array.prototype.reduce.call("a", function (t, r, e, n) {
                return n
            }) === "object"
    }
    if (!Array.prototype.reduce || !w) {
        Array.prototype.reduce = function W(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0;
            if (!l(t)) {
                throw new TypeError(t + " is not a function")
            }
    ...
    if (!Array.prototype.reduceRight) {
        Array.prototype.reduceRight = function tr(t) {
            var r = B(this), e = b && f(this) === "[object String]" ? this.split("") : r, n = e.length >>> 0;
            if (!l(t)) {
                throw new TypeError(t + " is not a function")
            }
    ...
    if (!Array.prototype.indexOf || [0, 1].indexOf(1, 2) !== -1) {
        Array.prototype.indexOf = function rr(t) {
            var r = b && f(this) === "[object String]" ? this.split("") : B(this), e = r.length >>> 0;
            if (!e) {
                return -1
            }
            var n = 0;
    ...
    if (!Array.prototype.lastIndexOf || [0, 1].lastIndexOf(0, -3) !== -1) {
        Array.prototype.lastIndexOf = function er(t) {
            var r = b && f(this) === "[object String]" ? this.split("") : B(this), e = r.length >>> 0;
            if (!e) {
                return -1
            }
    ...
    if (!Object.keys) {
        var S = !{toString: null}.propertyIsEnumerable("toString"), x = function () {
        }.propertyIsEnumerable("prototype"), A = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], j = A.length, O = function nr(t) {
            var r = f(t);
            var e = r === "[object Arguments]";
            if (!e) {
                e = !Array.isArray(r) && t !== null && typeof t === "object" && typeof t.length === "number" && t.length >= 0 && l(t.callee)
            }
            return e
        };
        Object.keys = function ir(t) {
            var r = l(t), e = O(t), n = t !== null && typeof t === "object", i = n && f(t) === "[object String]";
            if (!n && !r && !e) {
    ...
    var E = -621987552e5, N = "-000001";
    if (!Date.prototype.toISOString || new Date(E).toISOString().indexOf(N) === -1) {
        Date.prototype.toISOString = function or() {
            var t, r, e, n, i;
            if (!isFinite(this)) {
    ...
    var T = false;
    try {
        T = Date.prototype.toJSON && new Date(NaN).toJSON() === null && new Date(E).toJSON().indexOf(N) !== -1 && Date.prototype.toJSON.call({
    ...
    if (!T) {
        Date.prototype.toJSON = function ar(t) {
    ...
    var D = Date.parse("+033658-09-27T01:46:40.000Z") === 1e15;
    ...
    if ("ab".split(/(?:ab)*/).length !== 2 || ".".split(/(.?)(.?)/).length !== 4 || "tesst".split(/(s)*/)[1] === "t" || "".split(/.?/).length || ".".split(/()()/).length > 1) {
                ...
                while (u = r.exec(n)) {
                    ...
                    if (p > a) {
                        ...
                        if (u.length > 1 && u.index < n.length) {
                            Array.prototype.push.apply(i, u.slice(1))
                        }
                        s = u[0].length;
                        a = p;
                        if (i.length >= e) {
        ...
        String.prototype.split = function ur(t, r) {
    ...
    if (!C) {
        String.prototype.replace = function pr(t, r) {
            var e = l(r);
    ...
    if (parseInt(U + "08") !== 8 || parseInt(U + "0x16") !== 22) {
        parseInt = function (t) {
            var r = /^0[xX]/;
