"use strict";
angular.module("sbAdminApp").controller('applicationTypeEditCtrl', ['$scope', 'UserService', 'applicationTypeFactory', 'Notification',
    function ($scope, UserService, factory, Notification) {
